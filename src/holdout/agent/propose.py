...
def system_prompt(context: dict[str, str]) -> str:
    ...
    return (
        ...
        "design is refused with a reason code. Propose what you judge best; do not shade the "
        "minimum detectable effect upward to pass a check you can see coming, because a "
        "difference nobody would act on is not worth detecting.\n\n"
