...
+23.2 over 71 jobs**, warm mean 49.8 against cold 68.2 — which is what a **spurious**
invalidation costs rather than what the cache saves, every cold run in that sample being
one — rather than the projection this
